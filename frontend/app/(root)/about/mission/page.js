    ...
    <>
      ...
      <div className="font-sans p-2">
        ...
        <ul className="list-image md:flex justify-center">
          ...
          <li className="outline p-2 m-2">
            <Link href={'/'}>
              Hosting national and regional road transport and safety technical seminars and conferences
            </Link>
          </li>
        </ul>
        <p className="text-lg">
