...
const CapacityBuildingAndHumanResourceDevelopmentInTransport = () => {
  return (
    <div className="capacity-building-container p-4 sm:p-6 lg:p-8">
      <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">
        Capacity Building and Human Resource Development in Transport
      </h2>
      <div className="flex flex-col md:flex-row md:space-x-6">
        <div className="md:w-1/2 mb-4 md:mb-0">
          <Image width={100} height={100} src="/capacitybuilding.jpg" alt="Capacity Building" className="w-full h-auto rounded" />
        </div>
